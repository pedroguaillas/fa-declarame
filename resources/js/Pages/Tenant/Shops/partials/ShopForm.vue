    ...
    async (identification) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                showCreateContactModal.value =
                    true;

                createContactForm.value.identification =
                    identification;
...
function handleSubmit() {
    if (
        !validateVoucherWithIdentification()
    )
        return;
...
function filteredAccounts(): Account[] {
    ...
    if (!q)
        return props.accounts.slice(0, 8);
...
watchEffect(() => {
    props.form.sub_total = parseFloat(
        computedSubTotal.value.toFixed(
            2,
        ),
    );
    ...
    <form @submit.prevent="handleSubmit">
        ...
        <div class="border-t p-6">
            ...
            <div class="grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-4">
                ...
                <FormField id="base15" label="Base 15%" v-model="form.base15" type="number" step="0.01" />
        ...
        <div v-if="showCreateContactModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div class="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
                ...
                <div class="grid gap-4">
                    <FormSelect label="Tipo identificación" v-model="createContactForm.identification_type_id
                        " :options="identificationOptions
                            " />
