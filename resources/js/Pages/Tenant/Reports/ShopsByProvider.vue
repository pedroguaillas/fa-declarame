...
<template>
    ...
    <TenantLayout>
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-foreground text-2xl font-semibold">Compras por Proveedor</h1>
                <p class="text-muted-foreground mt-1 text-sm">Resumen de compras agrupado por proveedor</p>
            </div>
