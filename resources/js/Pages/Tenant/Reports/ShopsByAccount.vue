...
<template>
    <Head title="Compras por Cuentas" />
                ...
                <tbody class="divide-border bg-card divide-y">
                    <tr v-for="row in rows" :key="row.account_name">
                        <td class="px-4 py-3 text-sm">
                            <span v-if="row.account_code" class="text-muted-foreground mr-2 font-mono text-xs">
                                {{ row.account_code }}
                            </span>
                ...
                <tfoot class="bg-muted border-border border-t-2">
                    <tr>
                        ...
                        <td
                            ...
                            :class="
                                totals.retentions > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-muted-foreground'
                            "
                        >
