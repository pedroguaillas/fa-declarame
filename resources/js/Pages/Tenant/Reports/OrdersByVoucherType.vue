...
function clearFilters() {
    startDate.value = "";
    endDate.value = "";
    router.get(route("tenant.reports.orders-by-voucher-type"), {}, { preserveState: true });
}
...
function download() {
    ...
    window.location.href = route("tenant.reports.orders-by-voucher-type.export") + "?" + params.toString();
}
...
<template>
    ...
    <TenantLayout>
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-foreground text-2xl font-semibold">Ventas por Tipo de Comprobante</h1>
                <p class="text-muted-foreground mt-1 text-sm">Resumen de ventas agrupado por tipo de comprobante</p>
            </div>
