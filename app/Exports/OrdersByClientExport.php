...
class OrdersByClientExport extends DefaultValueBinder implements FromArray, WithColumnFormatting, WithColumnWidths, WithCustomValueBinder, WithEvents, WithHeadings, WithStyles, WithTitle
{
    use HasReportHeader;
    ...
    {
        $headings = ['RUC / Cédula', 'Cliente', 'Subtotal', 'No IVA', 'Excenta', 'Base 0%'];
