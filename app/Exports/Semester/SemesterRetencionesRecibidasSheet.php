...
class SemesterRetencionesRecibidasSheet extends DefaultValueBinder implements FromArray, WithColumnFormatting, WithColumnWidths, WithCustomValueBinder, WithEvents, WithHeadings, WithStyles, WithTitle
{
    use HasReportHeader;
    ...
    {
        return [
            'Fecha Retención', 'Serie Retención', 'Comprobante Venta', 'RUC / Cédula', 'Cliente',
